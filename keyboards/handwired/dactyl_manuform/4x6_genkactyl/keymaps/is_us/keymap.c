...
#define HAL_LSFT LM(_HALSHIFT, MOD_LSFT)
#define HAL_RSFT LM(_HALSHIFT, MOD_RSFT)
 ...
 * |  HYPER  |   Q   |-------+-------+-------+-------| |-------+-------+-------+-------|   P   | IS_ETH  |
 * |---------+-------|   S   |   D   |   F   |   G   | |   H   |   J   |   K   |   L   |-------+---------|
 * | LCTL_ES |   A   |-------+-------+-------+-------| |-------+-------+-------+-------|IS_SCLN| IS_ACUT |
 * |---------+-------|   X   |   C   |   V   |   B   | |   N   |   M   |IS_COMM|IS_DOT |-------+---------|
 * | CST_LSF |   Z   |-------+-------+---------------' `---------------+-------+-------|IS_SLSH| IS_BSLS |
 * |---------+-------|IS_LBRC|IS_RBRC|                                 |IS_ODIA|IS_EQL |-------+---------|
 * | OSFUNC  | IS_AE |---------------'                                 `---------------|IS_MINS| IS_THRN |
 * `-----------------'       ,-----------------------. ,-----------------------.       `-----------------'
 *                           | LGUI  |  SPC  |TD(NUMS| |  TAB  |  ENT  |LCTL_ES|
 *                           |-------|       |       | |       |       |-------|
 *                           | LALT  |-------+-------| |-------+-------|CST_RSF|
 *                           `-------| BSPC  |LCTL_ES| |IS_GRV | RALT  |-------'
...
/* Custom Shift Layer
*                    ,-------------------------------. ,-------------------------------.
 * ,-----------------|S(KC_W)|S(KC_E)|S(KC_R)|S(KC_T)| |S(KC_Y)|S(KC_U)|S(KC_I)|S(KC_O)|-----------------.
 * |         |S(KC_Q)|-------+-------+-------+-------| |-------+-------+-------+-------|S(KC_P)| S(IS_ET |
 * |---------+-------|S(KC_S)|S(KC_D)|S(KC_F)|S(KC_G)| |S(KC_H)|S(KC_J)|S(KC_K)|S(KC_L)|-------+---------|
 * |         |S(KC_A)|-------+-------+-------+-------| |-------+-------+-------+-------|IS_COLN| IS_DQUO |
 * |---------+-------|S(KC_X)|S(KC_C)|S(KC_V)|S(KC_B)| |S(KC_N)|S(KC_M)|IS_LABK|IS_RABK|-------+---------|
 * |         |S(KC_Z)|-------+-------+---------------' `---------------+-------+-------|IS_QUES| IS_PIPE |
 * |---------+-------|IS_LCBR|IS_RCBR|                                 |S(IS_OD|IS_PLUS|-------+---------|
 * |         |S(IS_AE|---------------'                                 `---------------|IS_UNDS| S(IS_TH |
 * `-----------------'       ,-----------------------. ,-----------------------.       `-----------------'
 *                           |       |       |       | |       |       |       |
 *                           |-------|       |       | |       |       |-------|
 *                           |       |-------+-------| |-------+-------|       |
...
[_SHIFT] = LAYOUT( \
    ...
    _______, S(KC_A), S(KC_S), S(KC_D), S(KC_F), S(KC_G),               S(KC_H), S(KC_J), S(KC_K), S(KC_L), IS_COLN, S(IS_2), \
    _______,  S(KC_Z), S(KC_X), S(KC_C), S(KC_V), S(KC_B),               S(KC_N), S(KC_M), 0x32, S(0x32), S(0x1e), LALT(0x32), \
    _______,  S(IS_AE), LALT(IS_7),LALT(IS_9),                                              S(IS_ODIA), 0x2a, S(0x18), S(IS_THRN), \
                            _______, _______, _______,               _______, _______, _______,                                 \
                            _______, KC_DEL, _______,                LALT(IS_QUOT), _______, _______                                  \
),
...
[_HALMAK] = LAYOUT( \
    ...
    HAL_LSFT, KC_F,  KC_M,   KC_V,   KC_C,   KC_SLSH,               KC_G,   KC_P,    KC_X,   KC_K,   KC_Y,_______, \
    _______,_______,_______,_______,                                             _______,_______,_______,_______,  \
                                    _______,_______,_______,    _______,_______,_______,                           \
                                    _______,_______,_______,    _______,_______,HAL_RSFT                           \
),

[_HALSHIFT] = LAYOUT( \
    _______, S(KC_W), S(KC_L), S(KC_R), S(KC_B), S(KC_Z),                IS_COLN, S(KC_Q), S(KC_U), S(KC_D), S(KC_J), S(IS_ETH),   \
    _______, S(KC_S),  S(KC_H), S(KC_N), S(KC_T), IS_LABK,               IS_RABK, S(KC_A), S(KC_E), S(KC_O), S(KC_I), IS_DQUO,   \
    _______, S(KC_F),  S(KC_M), S(KC_V), S(KC_C), IS_QUES,               S(KC_G), S(KC_P),  S(KC_X), S(KC_K), S(KC_Y),IS_PIPE, \
...
/* Numberpad
*                    ,-------------------------------. ,-------------------------------.
 * ,-----------------|       |       |       |IS_LBRC| |IS_RBRC|  P7   |  P8   |  P9   |-----------------.
 * |         |       |-------+-------+-------+-------| |-------+-------+-------+-------| RESET | IS_PLUS |
 * |---------+-------| PGUP  | PGDN  |  END  |IS_LPRN| |IS_RPRN|  P4   |  P5   |  P6   |-------+---------|
 * |         | HOME  |-------+-------+-------+-------| |-------+-------+-------+-------|IS_MINS| IS_QUOT |
 * |---------+-------|       |       |       |       | |       |  P1   |  P2   |  P3   |-------+---------|
 * |         |       |-------+-------+---------------' `---------------+-------+-------|IS_EQL | IS_UNDS |
 * |---------+-------|       | PSCR  |                                 |  P0   |       |-------+---------|
 * |         |       |---------------'                                 `---------------|       |         |
...
/* Symbols
*                    ,-------------------------------. ,-------------------------------.
 * ,-----------------|  F2   |  F3   |  F4   |       | |       |IS_AMPR|IS_ASTR|IS_LPRN|-----------------.
 * |         |  F1   |-------+-------+-------+-------| |-------+-------+-------+-------|       |         |
 * |---------+-------|  F6   |  F7   |  F8   |       | |       |IS_DLR |IS_PERC|IS_CIRC|-------+---------|
 * |         |  F5   |-------+-------+-------+-------| |-------+-------+-------+-------|       |         |
 * |---------+-------|  F10  |  F11  |  F12  |       | |       |IS_EXLM| IS_AT |IS_HASH|-------+---------|
 * |         |  F9   |-------+-------+---------------' `---------------+-------+-------|       |  NDSH   |
 * |---------+-------|       |       |                                 |IS_RPRN|       |-------+---------|
 * |         |       |---------------'                                 `---------------|       |  MDSH   |
 * `-----------------'       ,-----------------------. ,-----------------------.       `-----------------'
...
[_SYMBOLS] = LAYOUT(
    _______, KC_F1, KC_F2, KC_F3, KC_F4,IS_LBRC,                IS_RBRC, IS_AMPR, IS_ASTR, IS_LPRN,  _______, _______,   \
    _______, KC_F5, KC_F6, KC_F7, KC_F8,IS_LPRN,                IS_RPRN, IS_DLR, IS_PERC, IS_CIRC,  _______, _______,   \
