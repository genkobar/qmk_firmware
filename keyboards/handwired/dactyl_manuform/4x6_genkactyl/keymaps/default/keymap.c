...
enum {
    // clang-format off
    LOWERTAP,  // Our custom tap dance key; add any other tap dance keys to this enum
    // clang-format on
};

#define LOWER TD(LOWERTAP)
...
[_QWERTY] = LAYOUT( \
    ...
    UPPER,  HYPER, KC_LBRC,KC_RBRC,                                              KC_MINS, KC_EQL, HYPER, KC_RSFT,   \
                            KC_LGUI, KC_SPC, KC_BSPC,         KC_TAB, KC_ENT, KC_GRV,                                 \
                            HYPER, LOWER, KC_LALT,            KC_RALT, UPPER, LCTL_ESC                            \
),
...
[_UPPER] = LAYOUT(
    ...
    _______,_______,_______,HALMAK,                                              KC_MPRV,KC_MPLY,KC_MNXT,_______,\
                            KC_MB3,KC_MB1,KC_MB2,          KC_ACL0,KC_ACL1,KC_ACL2,                           \
                            KC_MB4,_______,_______,        _______, _______, _______                           \
)
};
// clang-format on
...
qk_tap_dance_action_t tap_dance_actions[] = {[LOWERTAP] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, ql_finished, ql_reset, 275)};
